...
null = [direction_storm,duration_storm,effect_on_objects,ambient_sounds_al,breath_vapors,snow_burst_server_side,snow_burst_client_side,al_fog_snow] execvm "AL_snowstorm\al_snow.sqf";
...
null = [80,240,false,40,false,true,false,true] execvm "AL_snowstorm\al_snow.sqf";

// with breath vapors and snow bursts on client side, fog using values you set in editor
null = [80,240,false,40,true,false,true,false] execvm "AL_snowstorm\al_snow.sqf";